...
* 주어진 기간의 일기 중 가장 즐거운 일기들을 뽑아 요약 
* Milvus의 metadata를 이용
* 캘린더로 날짜별 일기 확인 : 일기별 제목으로 캘린더에서 확인 가능

### 일기장 챗봇 
* 일기장 내용을 기반으로 내 고민을 나눌 수 있는 일기장 채팅
